...
- Continue reducing `LocalBehaviorController` into fallback-specific executors; carried armor equip, water/lava escape stand-search, local block-safety, local threat-safety, and local carried-inventory satisfaction checks are now split out as narrow helpers.
