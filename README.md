...
- `FriendEntity` and `FriendAutomatoneBridge` now expose and synchronize the offhand equipment slot instead of clearing it, matching Player2NPC's player-like mainhand/offhand/armor inventory shape more closely.
