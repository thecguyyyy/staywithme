...
- `CompanionLifecycle` also applies `FriendMemory.companionName` as the entity display name on spawn/recall, mirroring Player2NPC's character-derived companion display name while keeping `Companion` as the default.
