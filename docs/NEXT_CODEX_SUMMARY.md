...
- `CompanionLifecycle` applies `FriendMemory.companionName` as the entity display name on spawn/recall, mirroring Player2NPC's character-derived companion display name while preserving `Companion` as the default.
