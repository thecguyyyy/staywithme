...
- Player2NPC-style client companion selection was added:
  ...
  - login synchronization uses `PlayerEngineCharacterProfiles.requestCharacters(...)` to mirror Player2NPC assigned-character session summon behavior, falling back to the default memory companion if no PlayerEngine character is available
